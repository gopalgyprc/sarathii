      ...
      <Container>
        <div className="bg-gradient-to-br from-[#4B1458] via-[#2A0932] to-[#1A051F] rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-10 lg:p-14 text-[#FFFDF9] text-center relative overflow-hidden border border-[#D4AF6A]/30 shadow-2xl">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/15 text-xs sm:text-sm uppercase tracking-[0.2em] font-bold text-[#E6CFA5]">
              <Sparkles size={14} className="text-[#D4AF6A]" />
              <span>Take The First Step</span>
            </div>

            <h2 className="font-serif text-3xl sm:text-5xl lg:text-6xl text-[#FFFDF9] font-normal leading-[1.08] tracking-tight">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-[#E5DDD8]/95 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="pt-4 flex items-center justify-center gap-2 text-xs sm:text-sm text-[#E5DDD8]/80 font-serif italic">
              <MapPin size={14} className="text-[#D4AF6A]" />
